 ...
 *
 *
 *Lambda | 半衰期（根数） | 半衰期（时间） | 有效窗口（3-5倍半衰期） | 适用场景
 *------|--------------|--------------|---------------------|----------------
 *0.90   | ~7 根        | ~35 分钟      | 1.7-3 小时           | 极短期，捕捉快速波动
 *0.94   | ~11 根       | ~55 分钟      | 2.7-4.6 小时         | 短期敏感
 *0.95   | ~14 根       | ~70 分钟      | 3.5-5.8 小时         | 默认推荐值
 *0.98   | ~34 根       | ~2.9 小时     | 8.5-14 小时          | 当前配置，中长期平滑
 *0.99   | ~69 根       | ~5.8 小时     | 17-29 小时           | 长期趋势
 */
